      ...
      <section className="bg-gradient-to-r from-blue-600 to-green-600 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            ...
            Football, cricket, tennis, and more - all in one place.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              ...
              <p className="text-gray-600">
                Book your preferred turf with just a few clicks. 
            ...
            <Card className="text-center">
              ...
              <p className="text-gray-600">
                Hand-picked turfs with professional facilities. 
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { name: 'Basketball', icon: 'pi pi-circle', color: 'bg-orange-500' },
            ].map((sport) => (
              <Card key={sport.name} className="text-center cursor-pointer hover:shadow-lg transition-shadow">
                <div className={`w-16 h-16 ${sport.color} rounded-full mx-auto mb-4 flex items-center justify-center`}>
